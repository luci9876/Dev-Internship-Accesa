...
namespace Accesa.SportsBuddy.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class JoinSportCenterEventController : ControllerBase
    {
        private readonly IJoinSportCenterEventService _joinEventService;
        private readonly IMapper _mapper;

        public JoinSportCenterEventController(IJoinSportCenterEventService joinEventService, IMapper mapper)
        {
        ...
        public IActionResult GetJoinEvents()
        {
            try
            {
                ...
                var joinEventsDTOList = _mapper.Map<IList<JoinEventCreatedBySportCenterDTO>>(joinEvents.ToList());
        ...
        public IActionResult GetJoinEventById(int userId, int eventId)
        {
            try
            {
                ...
                var joinEventDTO = _mapper.Map<JoinEventCreatedBySportCenterDTO>(joinEvent);
        ...
        [HttpPost]
        public IActionResult AddJoinEvent([FromBody] JoinEventCreatedBySportCenterDTO joinEventDTO)
        {
            try
            {
                var joinEvent = _mapper.Map<JoinEventCreatedBySportCenter>(joinEventDTO);
                ...
                var resultReturnedDTO = _mapper.Map<JoinEventCreatedBySportCenterDTO>(resultReturned);
